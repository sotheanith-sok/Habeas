...
namespace Metrics.MeanAveragePrecision
{
    public class MeanAveragePrecision
    {
        ...
        public float GetMAP()
        {
            ...
            Console.WriteLine("Avg Non-Zero Accumulator Counts: " + avgAccumulatorCounts);
        ...
        public void GetAverageQueryLength()
        {
            Console.WriteLine("Calcualting Average Query Length");
            List<string> queries = ReadStringList(queryFilePath);
            int queryLengthTotal = 0;
            double aveQueryLen = 0;
            ...
            for (int i = 0; i < queries.Count; i++)
            {
                ...
                Console.WriteLine("Query Length = " + finalTerms.Count + " at query " + i);
                queryLengthTotal += finalTerms.Count;
                
        
            }
            aveQueryLen = (double)queryLengthTotal / queries.Count;

            Console.WriteLine("Average Query Length: " + aveQueryLen);
